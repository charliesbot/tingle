...
## Utilities
U src/utils/date.ts (in=23 prod=19 loc=64)  ← src/auth/login.ts src/auth/logout.ts …

## Orphans
O src/features/old/DeprecatedScreen.ts (loc=92)
...
> Before exploring this repo, run `tingle` and read `.tinglemap.md`. Use it to find hotspots (high out-degree files, likely where complex logic lives) and load-bearing utilities before opening individual files.
